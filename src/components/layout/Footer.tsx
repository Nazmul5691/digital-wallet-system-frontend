    ...
    <footer className="bg-gray-100 dark:bg-gray-900 transition-colors duration-500">
      <div className="mx-auto footer-section container px-4 py-16 sm:px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div>
            <div className="flex items-center gap-2 text-primary dark:text-teal-300">
              <Logo />
              <span className="text-xl font-bold">EzyPay</span>
            </div>
            <p className="mt-4 text-gray-600 dark:text-gray-400 max-w-xs">
              EzyPay is your secure, fast, and reliable digital wallet solution. Send, receive, deposit, or withdraw money anytime, anywhere.
            </p>

            {/* Social Icons */}
            <ul className="mt-6 flex gap-4">
              <li>
                <a href="#" target="_blank" rel="noreferrer" className="text-gray-700 dark:text-gray-200 hover:text-primary transition">
          ...
          {/* Links Section */}
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4 lg:col-span-2">
            <div>
              <p className="font-semibold text-gray-900 dark:text-white">Features</p>
              <ul className="mt-4 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li><Link to="/features" className="hover:text-primary transition">Instant Payments</Link></li>
                <li><Link to="/features" className="hover:text-primary transition">Seamless Transfers</Link></li>
                <li><Link to="/features" className="hover:text-primary transition">Deposit & Withdraw</Link></li>
                <li><Link to="/features" className="hover:text-primary transition">Transaction History</Link></li>
                <li><Link to="/features" className="hover:text-primary transition">Agent Network</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li><Link to="/#" className="hover:text-primary transition">Live Chat</Link></li>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
          &copy; {new Date().getFullYear()} EzyPay. All rights reserved.
        </p>
      </div>
    </footer>
  );
