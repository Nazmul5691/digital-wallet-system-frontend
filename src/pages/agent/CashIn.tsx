...
export default function CashIn() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-120px)] p-4">
            <div className="cash-in w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                {recipient && (
                    <Form {...cashInForm}>
                        <form onSubmit={cashInForm.handleSubmit(onCashInSubmit)} className="space-y-6">
                            ...
                            <Button type="submit" className="w-full cursor-pointer" disabled={isCashingIn}>
